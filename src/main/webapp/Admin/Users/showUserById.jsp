...
<body>
<form name="EditForm" method="post" action="Admins_updateUser" onsubmit="return check(this)">
<table>
	<tr>
		<td>User Id:</td>
	...
	<tr>
		...
		<td><input type="button" name="Back" value="Last Step" onclick="javascript:history.go(-1);"></td>
	</tr>
</table>
</form>
</body>
